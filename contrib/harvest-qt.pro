...
RESOURCES += src/qt/harvest.qrc src/qt/harvest_locale.qrc

TRANSLATIONS += src/qt/locale/harvest_bg.ts \
                src/qt/locale/harvest_de.ts \
                src/qt/locale/harvest_en.ts \
                src/qt/locale/harvest_es.ts \
                src/qt/locale/harvest_fi.ts \
                src/qt/locale/harvest_fr.ts \
                src/qt/locale/harvest_it.ts \
                src/qt/locale/harvest_ja.ts \
                src/qt/locale/harvest_pl.ts \
                src/qt/locale/harvest_pt.ts \
                src/qt/locale/harvest_ru.ts \
                src/qt/locale/harvest_sk.ts \
                src/qt/locale/harvest_sv.ts \
                src/qt/locale/harvest_vi.ts \
                src/qt/locale/harvest_zh_CN.ts \
                src/qt/locale/harvest_zh_TW.ts
