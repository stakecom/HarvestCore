...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Harvest harvest-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  harvest-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded harvest transaction") + "\n" +
                               "  harvest-tx [options] -create [commands]   " + _("Create hex-encoded harvest transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded harvest transaction
