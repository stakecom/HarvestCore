                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_zHC || context == Context::BIP_38) {
    ...
    // It doesn't make sense to show the checkbox for sending HC because you wouldn't check it anyway.
    if (context == Context::Send_HC || context == Context::Send_zHC) {
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet encryption"),
            tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR HC</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
