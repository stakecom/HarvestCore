...
static std::string ValueToString(CAmount nValue, bool AllowNegative = false)
{
    ...
    QString Str = BitcoinUnits::formatWithUnit(BitcoinUnits::HC, nValue);
...
{
    std::string genesisblockhash = "00000411b071bf797fa4c3b9c2c22814e9f7fe29f5e4c63e1eaa7898e46dddcc";
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", true)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (harvest.conf).");
            QMessageBox::warning(this, "Harvest Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
...
{
    QString CSS = "body {font-size:12px; color:#f8f6f6; bgcolor:#bc8e2c;}\n a, span { font-family: monospace; }\n span.addr {color:#bc8e2c; font-weight: bold;}\n table tr td {padding: 3px; border: 1px solid black; background-color: #bc8e2c;}\n td.d0 {font-weight: bold; color:#f8f6f6;}\n h2, h3 { white-space:nowrap; color:#bc8e2c;}\n a { color:#88f6f6; text-decoration:none; }\n a.nav {color:#bc8e2c;}\n";
