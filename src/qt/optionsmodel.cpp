...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::HC);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeHarvestAmount"))
        SoftSetArg("-anonymizeharvestamount", settings.value("nAnonymizeHarvestAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in harvest.cpp during shotdown to also remove the window positions
