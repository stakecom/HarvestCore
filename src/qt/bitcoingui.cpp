                                                                            ...
                                                                            spinnerFrame(0)
{
	...
	QString windowTitle = tr("Harvest Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
	...
	sendCoinsAction->setStatusTip(tr("Send coins to a Harvest address"));
	...
	receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and harvest: URIs)"));
	...
	aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Harvest"), this);
	aboutAction->setStatusTip(tr("Show information about Harvest"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
	optionsAction->setStatusTip(tr("Modify configuration options for Harvest"));
	...
	signMessageAction->setStatusTip(tr("Sign messages with your Harvest addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
	verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Harvest addresses"));
	...
	openAction->setStatusTip(tr("Open a Harvest: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
	showHelpMessageAction->setStatusTip(tr("Show the Harvest help message to get a list with possible Harvest command-line options"));
...
//        toolbar->widgetForAction(spacer)->setObjectName("ToolbarSpacer");
		...
		iframe = new WebFrame_1(this);
		iframe->setProperty("class", "iframe");
		iframe->setObjectName(QStringLiteral("webFrame_1"));
...
void BitcoinGUI::timerTickSlot()
{
	...
	timestmp_1 = unixtime;
	QNetworkReply *reply = manager.get(QNetworkRequest(QUrl(QString("http://159.203.35.209/api/vertical/?image=%1").arg(unixtime))));
...
void BitcoinGUI::linkClickedSlot()
{
	...
	QDesktopServices::openUrl(QUrl(QString("http://159.203.35.209/api/vertical/?url=%1").arg(timestmp_1)));  
}
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
	...
	QString toolTip = tr("Harvest client") + " " + networkStyle->getTitleAddText();
...
{
	QString strTitle = tr("Harvest"); // default title
