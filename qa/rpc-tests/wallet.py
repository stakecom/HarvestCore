...
#   c) node1 mines 32 blocks, so now node 0 has 60001hc, node 1 has 4250hc, node2 has none.
#   d) node0 sends 601 hc to node2, in two transactions (301 hc, then 300 hc).
