...
The Harvest project operates an open contributor model where anyone is
...
The following applies to code changes to the Harvest project, and is not to be
confused with overall Harvest Network Protocol consensus changes.

Whether a pull request is merged into Harvest rests with the project merge
...
Patches that change Harvest consensus rules are considerably more involved than
...
Where a patch set proposes to change the Harvest consensus, it must have been
...
The project leader is the release manager for each Harvest release.
