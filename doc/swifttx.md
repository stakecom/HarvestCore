...
This mechanism has been integrated into Bitcore-Node-Harvest which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Harvest-Project/insight-api-harvest#web-socket-api](https://github.com/Harvest-Project/insight-api-harvest#web-socket-api) 
* API: [https://github.com/Harvest-Project/insight-api-harvest#swifttx-transactions](https://github.com/Harvest-Project/insight-api-harvest#swifttx-transactions) 
...
By default, the Harvest daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Harvest daemon:
