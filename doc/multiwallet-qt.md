...
In order to support loading of multiple wallets in harvest-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is harvest.cpp.
...
Changes to harvest.cpp
----------------------
harvest.cpp is the entry point into harvest-qt, and as such, will require some minor modifications to provide hooks for
